...
+ Xamarin -> only tried it for educational purpose, VisualStudio in MacOS
#+end_src

I know, to many technologies, i'm not focused... is not my fault, is this fucking programming world, too many temptations for a disperse guy like i am.
...
*** Flycheck
#+BEGIN_SRC emacs-lisp
;; comento porque me da muchos problemas con python, mete python-mypy porque sí
